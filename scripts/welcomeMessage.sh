...
## To run the ROS example:
 source  /ws/app/ros_ws/install/setup.bash
	...
	sleep 2; \
	ros2 action send_goal /acc_control_mpc_g2o_action acc_interfaces/action/AccControlMPC "{horizon_length: 3, v_p: 15.0, v_h: 12.0, a_p: 0.5, a_p_weighted: 0.5, d_h: 4.5, force_prev: 10.0}";\
